...
spark = SparkSession \
    ...
    .master('local')\
    .config("spark.mongodb.input.uri", "mongodb://10.18.11.143:27017/vishwakarma_testing.citizen") \
    .config("spark.mongodb.output.uri", "mongodb://10.18.11.143:27017/vishwakarma_testing.citizen") \
